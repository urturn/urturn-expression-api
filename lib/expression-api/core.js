...
UT.Expression = (function(){
  ...
  function _buildExpression(expression){
    ...
    function dialog(type, options, callback) {
      ...
      switch (type) {
        case 'sound':
          soundDialog(options, callback);       
        break;
        case 'image':
          imageDialog(options, callback);
        break;
        case 'video':
          videoDialog(options, callback);
        break;
        case 'crop':
          cropDialog(options, callback);
        break;
      }
    }
    ...
    function imageDialog(options, callback) {
    ...
    function soundDialog(options, callback) {
      UT.Expression._callAPI(
    ...
    function videoDialog(options, callback) {
      UT.Expression._callAPI(
    ...
    function cropDialog(options, callback) {
